...
HIDDEN_APP_NAME=".$APP_NAME.app"
GUIDE_NAME="1 - Start Here.html"
GUIDE_PATH="$ROOT_DIR/packaging/Start Here.html"
...
/usr/bin/ditto --noextattr --norsrc "$APP_PATH" "$DMG_STAGING/$HIDDEN_APP_NAME"
