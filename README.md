...
3. Drag `Sniplet.app` into `Applications`
4. Open `Sniplet` from `Applications`
5. If macOS blocks the first launch, open `System Settings` > `Privacy & Security` and click `Open Anyway` for Sniplet
